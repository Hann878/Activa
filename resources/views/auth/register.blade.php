            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="#" class="text-nowrap logo-img text-center d-block py-3 w-100">
                  <img src="{{ asset('assets/images/logos/activalogo.png') }}" alt="">
                </a>
                <p class="text-center">Activa</p>
                <form action="/register" method="POST">
                  ...
                  <div class="mb-3">
                    <label for="exampleInputClass1" class="form-label">Class</label>
                    <select name="class_id" class="form-select" id="exampleInputClass1">
